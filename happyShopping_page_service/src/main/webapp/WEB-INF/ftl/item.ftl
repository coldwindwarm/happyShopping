...
<body ng-app="happyShopping" ng-controller="itemController" ng-init="num=1;loadSku()">
                ...
                <div class="clearfix choose">
                    ...
                    <dl>
                        ...
                        <#list spec.attributeValue as item>
                            ...
                            <dd>
                                <a ng-click="selectSpecification('${spec.attributeName}','${item}')"
                                   href="javascript:;"
                                   class="{{isSelected('${spec.attributeName}','${item}')?'selected':''}}">${item}
                                </a>
                            </dd>
                        </#list>
                        <br/>
