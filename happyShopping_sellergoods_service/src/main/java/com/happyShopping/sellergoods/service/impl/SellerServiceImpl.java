...
import com.happyShopping.mapper.SellerMapper;
import com.happyShopping.model.Seller;
import com.happyShopping.model.SellerExample;
...
public class SellerServiceImpl implements SellerService {
    ...
    public void add(Seller seller) {
        //给要注册的商家一个默认的状态0,0表示未审核,和当前注册的时间
        seller.setStatus(Seller.NOT_CHECK);
